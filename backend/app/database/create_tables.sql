...
CREATE TABLE IF NOT EXISTS calendar_events (
    ...
    event_origin_timezone TEXT NOT NULL,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),

    CONSTRAINT fk_calendar_events_hive FOREIGN KEY (hive_id) REFERENCES hives(id) ON DELETE CASCADE,
    CONSTRAINT fk_calendar_events_user FOREIGN KEY (creator_id) REFERENCES users(id) ON DELETE CASCADE
);

CREATE INDEX IF NOT EXISTS idx_calendar_events_hive_time ON calendar_events(hive_id, event_timestamp ASC);
